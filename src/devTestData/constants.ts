...
const DEV_TEST_DATA_LATE_CLIENT_FOLDER_NAME = 'Late Client';
const DEV_TEST_DATA_LATE_CLIENT_CODE = 'UI_TEST_LC';
const DEV_TEST_DATA_LATE_CLIENT_NAME = 'UI Test Late Client';
