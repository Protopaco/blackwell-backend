...
const buildEarlyClientRequest = (rootFolderLink: string): ClientCreateRequest => ({
  clientName: DEV_TEST_DATA_EARLY_CLIENT_NAME,
...
export default buildEarlyClientRequest;
